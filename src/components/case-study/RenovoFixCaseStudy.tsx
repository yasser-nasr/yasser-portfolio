...
export default function RenovoFixCaseStudy({ project }: { project: Project }) {
  return <main id="main-content" tabIndex={-1} className="flex-1 pt-32 md:pt-40"><article className="mx-auto max-w-6xl px-6">
    ...
    <section id="context" className="border-t border-edge py-16 md:py-24"><Heading eyebrow="01 / Context">Project Context</Heading>
    ...
    <section id="foundation" className="border-t border-edge py-16 md:py-24"><Heading eyebrow="02 / Strategy">Brand Foundation</Heading>
    ...
    <section id="identity" className="border-t border-edge py-16 md:py-24"><Heading eyebrow="03 / Identity">Logo & Identity</Heading>
    ...
    <section id="social" className="border-t border-edge py-16 md:py-24"><Heading eyebrow="05 / Content">Social Media System</Heading><p className="mt-7 max-w-3xl text-lg leading-8 text-ink-soft">Social content was designed as a repeatable communication system that could recognize problems, build trust, explain services, and move the audience toward enquiry.</p><ul className="mt-7 flex flex-wrap gap-2">{pillars.map((pillar) => <li key={pillar} className="rounded-full border border-edge px-3.5 py-2 text-xs text-ink-soft">{pillar}</li>)}</ul><SocialMediaShowcase />
    ...
    <section id="ai-visualization" className="border-t border-edge py-16 md:py-24"><Heading eyebrow="07 / Visualization">Visualizing the Outcome Before Completion</Heading><p className="mt-7 max-w-3xl text-lg leading-8 text-ink-soft">Before completed renovation photography was available, I created AI-assisted proposed visualizations using the real site, purchased materials, existing architecture, and planned design direction. The output was refined to preserve layout, perspective, proportions, and material choices.</p>
      ...
      <div className="mt-8 grid gap-6 sm:grid-cols-2">{transformations.map((file, index) => <Video key={file} src={`${base}/before-after/${file}`} label={`AI-assisted proposed renovation visualization ${index + 1}`} />)}</div>
    </section>

    <section id="website" className="border-t border-edge py-16 md:py-24"><Heading eyebrow="08 / Digital">Website Experience</Heading><p className="mt-7 max-w-3xl text-lg leading-8 text-ink-soft">The website extended the RenovoFix identity into a practical service and enquiry experience, helping users understand services, review work, explore annual contracts, and contact the company through forms or WhatsApp.</p>
      <div className="mt-10 space-y-10"><WebsiteScreenshot file="renovofix-website-home-desktop.webp" title="Home · Desktop" width={1422} height={5554} /><div className="grid items-start gap-8 md:grid-cols-[minmax(0,1.65fr)_minmax(15rem,0.65fr)]"><WebsiteScreenshot file="renovofix-website-services-desktop.webp" title="Services · Desktop" width={1422} height={6199} /><div className="grid gap-8"><WebsiteScreenshot file="renovofix-website-annual-contracts-mobile.webp" title="Annual Contracts · Mobile" width={800} height={16383} mobile /><WebsiteScreenshot file="renovofix-website-our-work-mobile.webp" title="Our Work · Mobile" width={800} height={16383} mobile /></div></div></div>
