...
export const projects: Project[] = [
  {
    ...
    subtitle: "Posters, Publications & Technical Communication",
    category: "Print Design / Editorial Design / Marketing Collateral",
    categories: ["packaging"],
    role: "Graphic Designer / Editorial Designer",
    industry: "Healthcare, manufacturing, engineering, education, sustainability, and equine nutrition",
    market: "Egypt / Saudi Arabia / GCC / Austria",
    statement: "A selected collection of print and editorial design spanning technical literature, sustainability advertising, healthcare collateral, corporate profiles, display graphics, academic communication, and bilingual publications.",
    image: "/projects/print/nestle-green-poster-design/nestle-sustainability-citylight-poster-mockup.webp",
    imageAlt: "Nestlé sustainability poster displayed in a freestanding citylight advertising mockup against a deep blue background.",
    imagePosition: "center",
    tags: ["Print Design", "Editorial Design", "Information Design", "Company Profile Design"],
    scope: ["Poster Design", "Editorial Layout", "Company Profiles", "Technical Data Sheets", "Bilingual Typesetting"],
    featured: false,
    publishable: true,
    seo: {
      title: "Print & Editorial Design Portfolio | Yasser Nasr",
      description: "Explore print and editorial design by Yasser Nasr, including Arabic company profiles, technical data sheets, posters, healthcare collateral, and publications.",
      canonical: "https://yassernasr.com/work/print-editorial-design",
      openGraphTitle: "Print & Editorial Design | Yasser Nasr",
      openGraphDescription: "Explore selected company profiles, posters, publications, technical documents, display graphics, and bilingual editorial design by Yasser Nasr.",
      image: "/projects/print/og/print-editorial-design-og.webp",
      imageAlt: "Nestlé sustainability poster in a freestanding citylight display representing Yasser Nasr’s print and editorial design portfolio.",
      imageWidth: 1200,
      imageHeight: 630,
    },
    structuredData: {
      headline: "Selected Print & Editorial Design Work",
      description: "Print and editorial design by Yasser Nasr across Arabic company profiles, technical literature, poster advertising, healthcare collateral, display graphics, and publication design.",
      keywords: ["Print Design Portfolio", "Editorial Design", "Arabic Company Profile Design", "Poster Design", "Technical Data Sheet Design", "Bilingual Publication Design", "Information Design"],
    },
  },
  {
    ...
    imageAlt: "Social media campaign designs for Sand Circus, Memo Travel, LAPE, and SBH arranged in an editorial collage.",
    tags: ["Social Media Design", "Campaign Design", "Digital Content"],
    featured: false,
    publishable: true,
    seo: {
      title: "Social Media & Campaign Design Portfolio | Yasser Nasr",
      description: "Social media and campaign design portfolio by Yasser Nasr, featuring Instagram carousels, Snapchat stories, profile branding, and multi-industry content.",
      canonical: "https://yassernasr.com/work/social-media-campaign-design",
      openGraphTitle: "Social Media & Campaign Design | Yasser Nasr",
      openGraphDescription: "Explore social media campaigns, Instagram carousels, Snapchat stories, and profile branding created for Sand Circus, PPR, SBH, LAPE, Memo Travel, and more.",
      image: "/projects/social-media-campaign-design/og/social-media-campaign-design-og.jpg",
      imageAlt: "Social Media and Campaign Design portfolio cover by Yasser Nasr featuring Sand Circus, Memo Travel, LAPE, and SBH artwork.",
      imageWidth: 1200,
      imageHeight: 630,
    },
    structuredData: {
      headline: "Selected Social Media & Campaign Design Work",
      description: "Social media and campaign design by Yasser Nasr across real estate, travel, legal marketing, environmental advocacy, culture, healthcare, and technology brands.",
      keywords: ["Social Media Design Portfolio", "Campaign Design", "Instagram Carousel Design", "Snapchat Story Design", "Facebook Profile Branding", "Digital Content Design"],
    },
  },
  {
